...
/**
 * 创建: rocketmq-example 描述: 编写者:农剑斌<nong-juan@163.com> 版本: 0.0.1 创建时间:15-12-17
 * 下午5:23
 */
public class HttpRequestUtil {
     ...
     * @throws IOException
     */
    public static Map<String, String> getResultData(String idCode, String url,
                                                    String charset, Map<String, String> dataMap) throws IOException {
        ...
        try {
            ...
            if (dataMap.get("reqWofinance") != null) {
                HttpEntity entity1 = new StringEntity(
                        dataMap.get("reqWofinance"), charset);
            ...
            resultMap.put("StatusCode",
                    String.valueOf(StatusLine.getStatusCode()));// 返回状态码
     ...
     * @return:
     */
    public static Map<String, String> doGet(String idCode, String url,
                                            String charset, Map<String, String> dataMap) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        long begin = System.currentTimeMillis();
        // System.out.println(doGet("104",
        // "https://132.37.5.196:14823/route/wofinancecmb", "utf-8",
        // params1));
        if (args.length > 1) {
            if (args[1].endsWith("1")) {
                System.out.println(getResultData("",
                        "https://132.37.5.196:14823/route/wofinancecmb",
                        "utf-8", new HashMap<String, String>()));
            }
            if (args[1].endsWith("2")) {
                System.out.println(getResultData("",
                        "https://open.woego.cn/route/wofinancecmb", "utf-8",
